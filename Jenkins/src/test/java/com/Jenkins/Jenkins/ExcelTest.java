...
public class ExcelTest{
    ...
    {    //input stream object creation
    	...
    	FileInputStream excel = new FileInputStream("C:\\Users\\aghorpade\\Documents\\GitHub\\Jenkins\\Jenkins\\src\\test\\java\\com\\Jenkins\\Jenkins\\Data.xls");
...
void LoginUsingJXL(String uname1, String pwd1) throws Exception {
    ...
    WebElement uname = driver.findElement(By.name("txtUsername")); // Updated the input field name
    Thread.sleep(3000); // You can replace this with an explicit wait for better synchronization

    WebElement pword = driver.findElement(By.name("txtPassword")); // Updated the input field name
